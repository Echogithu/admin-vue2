 ...
 */
import Vue from 'vue';
import { Button, Dropdown, Input, Layout, Avatar, Icon, Menu, Breadcrumb } from 'ant-design-vue';

/*需要注册的组件名字, 注册之前需要确保已经import这个组件*/
const components = [Button, Input, Layout, Dropdown, Avatar, Icon, Menu, Breadcrumb];
register(components);
